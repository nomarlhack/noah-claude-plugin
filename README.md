...
**D. 나머지 (~36개)** — 패턴·generic 룰과 공통 층으로 검토합니다. 설정 점검형(보안 헤더, TLS, Android WebView/Manifest, iOS WebView/Storage/Crypto 등)이 많습니다.
...
| 47 | android-deeplink-scanner | Android Deeplink | mobile |
...
| 50 | android-webview-scanner | Android WebView 보안 (JS 인젝션 / WebSettings / SSL) | mobile |
| 51 | android-ipc-scanner | Android IPC / Intent Redirection / PendingIntent | mobile |
| 52 | android-manifest-scanner | Android Manifest 하드닝 (exported / debuggable / cleartext) | mobile |
| 53 | ios-webview-scanner | iOS WKWebView JS 인젝션 / SSL bypass / navigation 미검증 | ios |
| 54 | ios-storage-scanner | iOS 민감 데이터 저장 (UserDefaults / Keychain 과접근 / 파일 평문) | ios |
| 55 | ios-crypto-scanner | iOS 약한 암호화 (AES-ECB / DES / MD5 / 정적 IV / 하드코딩 키) | ios |
